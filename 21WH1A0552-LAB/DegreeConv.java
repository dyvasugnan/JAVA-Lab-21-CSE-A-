...
import javax.swing.*;
import java.math.*;
public class DegreeConv extends JFrame implements ActionListener{
		JButton b1,b2,b3;
		JTextField t1,t2;
		JLabel l1,l2;
		DegreeConv(){
		...
		public void actionPerformed(ActionEvent ae) {
			...
			if(s.equals("C to F")) {
				...
				double ans = (num*9/5)+32;				
				t2.setText(ans+"");
			}
			else if(s.equals("F to C")){
				double num = Double.parseDouble(t1.getText());
		...
		public static void main(String args[]) {
			DegreeConv d = new DegreeConv();
			d.setTitle("Degree Conversion");
			d.setVisible(true);
			d.setSize(600,600);
