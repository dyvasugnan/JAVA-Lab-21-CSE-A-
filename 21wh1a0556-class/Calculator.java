...
public class Calculator extends Frame implements ActionListener {
    Button b0, b1, b2, b3, b4, b5, b6, b7, b8, b9, plus, minus, div, mul, equal, clear, delete;
    Label l;
    TextField t;
    int result;
    Calculator() {
        ...
        div.setBounds(85,410,60,40);
        equal.setBounds(225,350,60,100);
        minus.setBounds(155,410,60,40);
        clear.setBounds(15,170,60,40);
        delete.setBounds(85,170,60,40);
