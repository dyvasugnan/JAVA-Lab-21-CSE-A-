...
public class Arrays{
    public static void main(String args[]) {
        ...
        System.out.println("Enter elements into Array1D: ");
        a1.read();
        System.out.println("Array1D :  ");
        a1.display();

        int r1=3, c1=3;
        Array2D a2 = new Array2D(r1, c1);
        System.out.println("Enter elements into Array2D : ");
        a2.read();
        System.out.println("Array2D :  ");
        a2.display();

        int l2=3,r2=3,c2=3;
        Array3D a3 = new Array3D(l2, r2, c2);
        System.out.println("Enter elements into Array3D: ");
        a3.read();
